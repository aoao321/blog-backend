...
import com.aoao.blog.common.model.front.vo.commnet.FindQQUserInfoRspVO;
import com.aoao.blog.common.utils.Result;
import com.aoao.blog.common.utils.StringUtil;
...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public Result findQQUserInfo(FindQQUserInfoReqVO findQQUserInfoReqVO) {
        ...
        try {
            ...
            if (Objects.equals(map.get("code"), HttpStatus.OK.value())) {
                ...
                if (!CollectionUtils.isEmpty(data)) {
                    // 获取用户头像、昵称、邮箱
                    return Result.success(FindQQUserInfoRspVO.builder()
