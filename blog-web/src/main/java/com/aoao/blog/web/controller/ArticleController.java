...
public class ArticleController {
    ...
    @ApiOperation("查询文章详情")
    @PostMapping("/detail")
    public Result<FindArticleDetailRspVO> detail(@RequestBody FindArticleDetailReqVO findArticleDetailReqVO) {
        FindArticleDetailRspVO vo = articleService.detail(findArticleDetailReqVO);
